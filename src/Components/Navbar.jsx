...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-base-100 shadow-lg sticky top-0 px-8">
      <div className="flex-1">
        <Link to="/" className=" text-2xl text-secondary font-bold">
          Post<span className="text-primary">Vibe</span>
        </Link>
      </div>
      <div className="flex-none">
        <ul className="menu menu-horizontal px-1 text-lg font-bold flex gap-5 mr-5">
