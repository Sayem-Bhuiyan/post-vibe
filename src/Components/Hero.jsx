...
const Hero = () => {
  return (
    <div className="hero h-full  flex items-center justify-center -mt-20">
      <div className="hero-content text-center">
        <div className="max-w-lg">
          <h1 className="text-5xl font-bold">
            Welcome to <span className="bg-300% bg-gradient-to-r from-primary via-blue-500 to-secondary text-transparent bg-clip-text animate-gradient">PostVibe</span>
          </h1>
          <p className="py-6">
